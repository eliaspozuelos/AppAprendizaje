...
class Centenas extends StatefulWidget {
  const Centenas ({Key? key}) : super(key: key);

  @override
  CentenasState createState() => CentenasState();
}

class CentenasState extends State<Centenas>{
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/Centenas.mp4');
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [                          
                          ...
                          Text(
                            " Las centenas son como supergrupos de números que hacen que contar cosas grandes sea emocionante. Cuando cuentas del 1 al 100, ¡has llegado a una centena! Pero no te detienes ahí. Si sigues contando, cuando llegas al 200, ¡tienes dos centenas!",
