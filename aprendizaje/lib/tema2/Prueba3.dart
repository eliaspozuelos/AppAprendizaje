...
class Prueba3 extends StatefulWidget {
  @override
  _Prueba3State createState() => _Prueba3State();
}
             ...
             // color: const Color.fromARGB( 255, 255, 255, 255), // Cambia el color de fondo de la Card
              ...
              child: Column(
                ...
                children: [
                    SizedBox(height: 15),
                  ListTile(
                    title: Text('Se desecharán 7 de los siguientes bolígrafos. ¿Cuántos van a quedar?'),
                  ),
                  Image.asset(
                    'assets/Ejer3-1.png', // Reemplaza con la ruta de tu imagen
                    width:
                        700, // Ajusta el ancho de la imagen según tus necesidades
                    height:
